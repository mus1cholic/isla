...
// --- ValidateSleepCycleExtractionResult ---

TEST(MemoryStoreTest, SleepCycleExtractionResultRejectsDuplicateLongTermEpisodeIds) {
                ...
                LongTermEpisodeWrite{
                    .episode =
                        LongTermEpisode{
                            .lte_id = "lte_001",
                            .user_id = "user_001",
                            .summary_compressed = "second",
                            .complexity = 4,
                            .created_at = Ts("2026-03-08T14:01:00Z"),
                        },
                },
            },
...
TEST(MemoryStoreTest, SleepCycleExtractionResultRejectsLinksToMissingEpisodes) {
    const absl::Status status = ValidateSleepCycleExtractionResult(SleepCycleExtractionResult{
        .entities = {},
        .relationships = {},
        .long_term_episodes =
