...
inline constexpr std::string_view kPhaseMemoryMidTermFlushDecide = "memory.mid_term.flush_decide";
inline constexpr std::string_view kPhaseMemoryMidTermCompact = "memory.mid_term.compact";
inline constexpr std::string_view kPhaseMemoryMidTermEmbedSummary = "memory.mid_term.embed_summary";
...
inline constexpr std::string_view kPhaseToolExecute = "tool.execute";
...
inline constexpr std::string_view kPhaseProviderResponseHeaders = "provider.response_headers";
inline constexpr std::string_view kPhaseProviderFirstBodyByte = "provider.first_body_byte";
inline constexpr std::string_view kPhaseProviderFirstSseEvent = "provider.first_sse_event";
inline constexpr std::string_view kPhaseProviderFirstTextDelta = "provider.first_text_delta";
